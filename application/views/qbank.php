...
<div id="container">
	...
	<td ><center><?php echo anchor('qbank/view/'.$question['qid'],img(array('src'=>'images/view.png','title'=>'View')));?></center></td>
	<td ><center><?php echo anchor('qbank/edit/'.$question['qid'],img('images/edit.png'))?></center></td>
	<td ><center><a href="javascript:delq('<?php echo $question['qid']?>');"><?php echo img('images/delete.png')?></a></center></td>
	</tr>
	<?php } ?>
	</table>
	<?php if(isset($limit)){
